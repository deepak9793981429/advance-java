...
<body class="h">
     ...
     <h3 class="text-secondary">Relogin form</h3>
     ...
     <input type="hidden" name="command" value="ADD"/>
      ...
      <tr>
      <td><label></label></td>
      <td><button type="submit" onClick="return validateForm()" class="btn btn-success btn-block text-light ml-5">Save</button></td>
      </tr>
